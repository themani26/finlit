...
import { retireBasicsContent } from "@/data/investing/retire"; 
...
export function FinancialBentoGridRe({ title, content }: FinancialBentoGridProps) {
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={retireBasicsContent.title}
        description={retireBasicsContent.description}
        content={retireBasicsContent}
...
export default FinancialBentoGridRe;