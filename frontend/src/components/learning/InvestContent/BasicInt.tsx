...
import { investingBasicsContent } from "@/data/investing/basics"; 
...
export function FinancialBentoGridI({ title, content }: FinancialBentoGridProps) {
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={investingBasicsContent.title}
        description={investingBasicsContent.description}
        content={investingBasicsContent}
...
export default FinancialBentoGridI;