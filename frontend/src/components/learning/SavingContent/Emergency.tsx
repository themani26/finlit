...
import {emergencyBasicsContent} from "@/data/saving/emergency"; 
...
export function FinancialBentoGrid3({ title, content }: FinancialBentoGridProps) {
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={emergencyBasicsContent.title}
        description={emergencyBasicsContent.description}
        content={emergencyBasicsContent}
...
export default FinancialBentoGrid3;