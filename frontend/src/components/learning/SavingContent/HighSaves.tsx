...
import {highYieldContent} from "@/data/saving/highsaves"; 
...
export function FinancialBentoGrid2({ title, content }: FinancialBentoGridProps) {
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={highYieldContent.title}
        description={highYieldContent.description}
        content={highYieldContent}
...
export default FinancialBentoGrid2;