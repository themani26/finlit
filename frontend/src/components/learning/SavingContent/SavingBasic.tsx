...
import {savingBasicsContent } from "@/data/saving/basics"; 
...
export function FinancialBentoGrid1({ title, content }: FinancialBentoGridProps) {
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={savingBasicsContent.title}
        description={savingBasicsContent.description}
        content={savingBasicsContent}
...
export default FinancialBentoGrid1;