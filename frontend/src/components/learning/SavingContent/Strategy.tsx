...
import {smartSavingBasicsContent} from "@/data/saving/savestrat"; 
...
export function FinancialBentoGrid4({ title, content }: FinancialBentoGridProps) {
    ...
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[20rem]">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          header={
<ExpandableCard
        title={smartSavingBasicsContent.title}
        description={smartSavingBasicsContent.description}
        content={smartSavingBasicsContent}
...
export default FinancialBentoGrid4;